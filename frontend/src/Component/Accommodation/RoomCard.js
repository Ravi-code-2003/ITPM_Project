...
const RoomCard = ({ room, onViewDetails, showMatchScore = false, matchScore = null }) => {
  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow flex flex-col h-full bg-white dark:bg-gray-800 border border-pink-200 dark:border-gray-700" padding="none">
      {/* Image with Carousel */}
      <div className="relative h-44 bg-white dark:bg-gray-700/40 group flex-shrink-0">
          ...
          <>
            <img
              ...
              onError={(e) => {
                ...
                e.target.parentElement.innerHTML = '<div class="w-full h-full flex items-center justify-center bg-white"><span class="text-gray-500">Failed to load image</span></div>';
              }}
            />
            ...
            {hasMultipleImages && (
              <>
                <button
                  ...
                  className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/95 hover:bg-white rounded-full p-1.5 shadow-md opacity-0 group-hover:opacity-100 transition-opacity z-10"
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/95 hover:bg-white rounded-full p-1.5 shadow-md opacity-0 group-hover:opacity-100 transition-opacity z-10"
